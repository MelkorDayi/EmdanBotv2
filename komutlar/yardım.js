...
exports.run = function(client, message) {
    ...
    const embed = new Discord.RichEmbed()
        ...
        .setImage("https://images-ext-2.discordapp.net/external/PiJp35u3aqqftbkBNHuo_4M-q3c-5rqxaizhHrSJ-TE/https/cdn.discordapp.com/icons/478640219235680259/a05c679974b7d1ab853802e865960d07.webp")
        .setColor(0x00AE86)
   ...
   const embed = new Discord.RichEmbed()
        ...
        .setImage("https://images-ext-2.discordapp.net/external/PiJp35u3aqqftbkBNHuo_4M-q3c-5rqxaizhHrSJ-TE/https/cdn.discordapp.com/icons/478640219235680259/a05c679974b7d1ab853802e865960d07.webp")
        .setColor(0x00AE86)
        .addField("/sil <miktar>", " : Belirttiğiniz kadar mesaj siler.", true)
        .addField("/yaz <mesaj>", " : Bota mesaj yazdırır.", true)
   message.channel.send(embed)
};
